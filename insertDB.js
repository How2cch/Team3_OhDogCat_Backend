...
(async () => {
  ...
  // for (const item of data) {
    ...
    //   'INSERT INTO post (`post_type_id`, `user_id`, `post_title`,  `main_photo`, `status`, `likes`) VALUES (1, ?, ? , ?,1, ?)',
    //   [data[item].user_id, data[item].post_title, data[item].post_main_photo, data[item].likes]
